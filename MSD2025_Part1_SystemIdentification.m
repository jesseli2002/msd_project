...
save('dat/part1.B.chirp.mat', 'y', 'u', 't', 'ts', 'fmin', 'fmax');

%% Do it again with white noise
...
subplot(2, 1, 1);
plot(t, u);
title('Input white noise Signal');
xlabel('Time (s)');
ylabel('Amplitude');
...
save('dat/part1.B.white.mat', 'y', 'u', 't', 'ts', 'fmin', 'fmax');
...
% 
% np = 1; % Tune number of poles
% nz = 1; % Tune number of zeros
